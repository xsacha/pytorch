...
if(USE_QNNPACK)
  ...
  list(APPEND Caffe2_DEPENDENCY_LIBS ARM_NEON_2_x86_SSE::ARM_NEON_2_x86_SSE)
endif()
...
if (CAFFE2_CMAKE_BUILDING_WITH_MAIN_REPO)
  ...
  if (ANDROID OR IOS)
    ...
    list(APPEND Caffe2_PUBLIC_DEPENDENCY_LIBS onnx::onnx_proto)
  else()
    caffe2_interface_library(onnx::onnx onnx_library)
    list(APPEND Caffe2_PUBLIC_DEPENDENCY_LIBS onnx::onnx)
  endif()
